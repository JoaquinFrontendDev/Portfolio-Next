  ...
  return (
    ...
    >
      <div className='flex flex-col gap-6 justify-center items-center h-full mt-24 mx-auto'>
        ...
        <BoltIcon className='w-12 h-12 animate-bounce text-blue-600' />
      </div>
      <div className='w-full p-[30px] flex flex-wrap gap-10 items-center justify-center mt-10'>
        <ServiceCard
          key={services[0].id}
      ...
      <div className='flex flex-col gap-6 justify-center items-center h-full mt-24 mx-auto'>
        ...
        <CommandLineIcon className='w-12 h-12 animate-bounce text-blue-600' />
      </div>
      <div
        className='h-[40vh] w-full flex-1 flex flex-col gap-12 items-center'
        ref={ref}
      >
        <div className='w-4/5 flex items-center justify-evenly mt-10 mx-auto gap-8 flex-wrap'>
          <motion.img
